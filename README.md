...
Figure 1 illustrates the validation perplexity over the 10 training epochs.
...
Figure 2 compares the average training loss for both models.

<img width="463" height="331" alt="image" src="https://github.com/user-attachments/assets/19cc986c-82d1-48fb-a99c-3056bd4a0269" />

This plot indicates that the proposed L2T-Hyena model converges significantly faster and to a lower final loss value than the baseline. This suggests a more efficient learning process on the training data, which also translated to better generalization (as seen in Figure 1).
